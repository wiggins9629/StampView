...
public class StampView {
    ...
    private static final float DEFAULT_SEMICIRCLE_GAP = 5f;
    private static final float DEFAULT_SEMICIRCLE_RADIUS = 2.5f;
    private static final float DEFAULT_SEMICIRCLE_COVER_STROKE_WIDTH = 1f;
    ...
    //半圆覆盖画笔
    private Paint semicirclePaintCover;
    //虚线画笔
    ...
    //半圆覆盖颜色
    private int semicircleCoverColor = DEFAULT_SEMICIRCLE_COLOR;
    //半圆覆盖线宽
    private float semicircleCoverStrokeWidth = DEFAULT_SEMICIRCLE_COVER_STROKE_WIDTH;
    //开启顶部半圆曲线
    ...
    public StampView(View view, Context context, AttributeSet attrs, int defStyle) {
        this.context = context;
        this.view = view;
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StampView, defStyle, 0);
        semicircleRadius = a.getDimensionPixelSize(R.styleable.StampView_sv_semicircle_radius, dp2Px(DEFAULT_SEMICIRCLE_RADIUS));
        semicircleGap = a.getDimensionPixelSize(R.styleable.StampView_sv_semicircle_gap, dp2Px(DEFAULT_SEMICIRCLE_GAP));
        semicircleCoverStrokeWidth = a.getDimensionPixelSize(R.styleable.StampView_sv_semicircle_cover_stroke_width, dp2Px(DEFAULT_SEMICIRCLE_COVER_STROKE_WIDTH));
        semicircleColor = a.getColor(R.styleable.StampView_sv_semicircle_color, DEFAULT_SEMICIRCLE_COLOR);
        semicircleCoverColor = a.getColor(R.styleable.StampView_sv_semicircle_cover_color, DEFAULT_SEMICIRCLE_COLOR);

        isSemicircleTop = a.getBoolean(R.styleable.StampView_sv_semicircle_top, isSemicircleTop);
        isSemicircleBottom = a.getBoolean(R.styleable.StampView_sv_semicircle_bottom, isSemicircleBottom);
        isSemicircleLeft = a.getBoolean(R.styleable.StampView_sv_semicircle_left, isSemicircleLeft);
        isSemicircleRight = a.getBoolean(R.styleable.StampView_sv_semicircle_right, isSemicircleRight);

        dashLineLength = a.getDimensionPixelSize(R.styleable.StampView_sv_dash_line_length, dp2Px(DEFAULT_DASH_LINE_LENGTH));
        dashLineHeight = a.getDimensionPixelSize(R.styleable.StampView_sv_dash_line_height, dp2Px(DEFAULT_DASH_LINE_HEIGHT));
        dashLineGap = a.getDimensionPixelSize(R.styleable.StampView_sv_dash_line_gap, dp2Px(DEFAULT_DASH_LINE_GAP));
        dashLineColor = a.getColor(R.styleable.StampView_sv_dash_line_color, DEFAULT_DASH_LINE_COLOR);

        isDashLineTop = a.getBoolean(R.styleable.StampView_sv_dash_line_top, isDashLineTop);
        isDashLineBottom = a.getBoolean(R.styleable.StampView_sv_dash_line_bottom, isDashLineBottom);
        isDashLineLeft = a.getBoolean(R.styleable.StampView_sv_dash_line_left, isDashLineLeft);
        isDashLineRight = a.getBoolean(R.styleable.StampView_sv_dash_line_right, isDashLineRight);

        dashLineMarginTop = a.getDimensionPixelSize(R.styleable.StampView_sv_dash_line_margin_top, dp2Px(DEFAULT_DASH_LINE_MARGIN));
        dashLineMarginBottom = a.getDimensionPixelSize(R.styleable.StampView_sv_dash_line_margin_bottom, dp2Px(DEFAULT_DASH_LINE_MARGIN));
        dashLineMarginLeft = a.getDimensionPixelSize(R.styleable.StampView_sv_dash_line_margin_left, dp2Px(DEFAULT_DASH_LINE_MARGIN));
        dashLineMarginRight = a.getDimensionPixelSize(R.styleable.StampView_sv_dash_line_margin_right, dp2Px(DEFAULT_DASH_LINE_MARGIN));
    ...
    private void init() {
        ...
        semicirclePaintCover = new Paint(Paint.ANTI_ALIAS_FLAG);
        semicirclePaintCover.setDither(true);
        semicirclePaintCover.setColor(semicircleCoverColor);
        semicirclePaintCover.setStyle(Paint.Style.STROKE);
        semicirclePaintCover.setStrokeWidth(semicircleCoverStrokeWidth);
    ...
    public void onDraw(Canvas canvas) {
        if (isSemicircleTop) {
            for (int i = 0; i < semicircleNumX; i++) {
                ...
                canvas.drawCircle(x, 0, semicircleRadius, semicirclePaintCover);
            }
        }
        ...
        if (isSemicircleBottom) {
            for (int i = 0; i < semicircleNumX; i++) {
                ...
                canvas.drawCircle(x, viewHeight, semicircleRadius, semicirclePaintCover);
            }
        }
        ...
        if (isSemicircleLeft) {
            for (int i = 0; i < semicircleNumY; i++) {
                ...
                canvas.drawCircle(0, y, semicircleRadius, semicirclePaintCover);
            }
        }
        ...
        if (isSemicircleRight) {
            for (int i = 0; i < semicircleNumY; i++) {
                ...
                canvas.drawCircle(viewWidth, y, semicircleRadius, semicirclePaintCover);
            }
        }
    ...
    public float getSemicircleCoverStrokeWidth() {
        return px2Dp(semicircleCoverStrokeWidth);
    }

    public void setSemicircleCoverStrokeWidth(float semicircleCoverStrokeWidth) {
        if (this.semicircleCoverStrokeWidth != semicircleCoverStrokeWidth) {
            this.semicircleCoverStrokeWidth = semicircleCoverStrokeWidth;
            calculate();
            view.invalidate();
        }
    }
    ...
    public int getSemicircleCoverColor() {
        return semicircleCoverColor;
    }

    public void setSemicircleCoverColor(int semicircleCoverColor) {
        if (this.semicircleCoverColor != semicircleCoverColor) {
            this.semicircleCoverColor = semicircleCoverColor;
            calculate();
            view.invalidate();
        }
    }
